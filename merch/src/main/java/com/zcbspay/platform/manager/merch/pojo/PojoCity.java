package com.zcbspay.platform.manager.merch.pojo;
...
@Entity
@Table(name = "T_CITY")
public class PojoCity implements java.io.Serializable {
	
	private static final long serialVersionUID = -110685166716986133L;
	...
	/** full constructor */
	public PojoCity(String CName, String CZcode, String CPcode) {
