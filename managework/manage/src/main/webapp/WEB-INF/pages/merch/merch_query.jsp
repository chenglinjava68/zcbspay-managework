...
<script>
  	var width = $("#continer").width();
		...
		function toMerchChange(merchApplyId){
			window.location.href= "<%=basePath%>" +'merchant/toMerchChange?merchApplyId='+merchApplyId;
			//window.event.returnValue = false;
		}

		function toMerchDetail(merchApplyId){
			window.location.href= "<%=basePath%>" +'merchant/toMerchDetail?merchApplyId='+merchApplyId;
			//window.event.returnValue = false;
		}
		function toMerchAudit(merchApplyId){
			flag=$('#flag_ins').val();
			window.location.href= "<%=basePath%>" +'merchant/toMerchDetail?merchApplyId='+merchApplyId+'&flag='+flag;
			//window.event.returnValue = false;
		}
		function toUpload(merchApplyId){
			window.location.href= "<%=basePath%>" +'merchant/toUpload?merchApplyId='+merchApplyId;
		}
