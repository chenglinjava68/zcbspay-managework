  	...
  	var width = $("#continer").width();
		...
		function deleteUser(userId){
			$.ajax({
				...
				$("#saveForm").attr("action","user/delete");
...
// 			var userId = $("#userId_addrole").val();
// 		    var conPwd =$("#passwordtwo").val();
// 		    var newPwd =$("#passwordone").val();
// 		if(conPwd==""||newPwd==""){
// 			document.getElementById("tishi").innerHTML = "密码不能为空";
// 			$('#passwordRestForm :input').val('');
// 		}else{
// 				if(newPwd==conPwd){
// 					var form = document.forms['passwordRestForm']; 
// 			        $.ajax({
// 						type: "POST",
// 					  	url: "user/resetPwd",
// 					  	data: "rand="+new Date().getTime()+"&userId="+userId+"&newPwd="+newPwd+"&conPwd="+conPwd,
// 					 	dataType: "json",
// 					 	success:function(json){
// 					 	}
// 					});
