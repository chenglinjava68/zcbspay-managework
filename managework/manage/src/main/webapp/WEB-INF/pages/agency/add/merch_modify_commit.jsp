	...
	<div style="margin: 5px;" id="continer">
		<div id="title" name="title" class="easyui-panel" title="委托机构开通"
			...
			<div style="padding-left: 5px; padding-right: 5px">
				<form id="merchDateForm" action="agency/commitMerch" method="post">
...
<script>
  $(function(){
	...
	function toFirstStep(){
		window.location.href= "<%=basePath%>" +'/agency/toMerchModifyEdit?merchApplyId='+$('#merchApplyId').val();
	}
	
	function commitMerch(){
			$.ajax({
				type: "POST",
				url: "agency/commitMerchModify",
