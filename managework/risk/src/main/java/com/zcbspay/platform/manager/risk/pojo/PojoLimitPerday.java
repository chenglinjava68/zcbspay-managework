...
public class PojoLimitPerday implements java.io.Serializable{
	private static final long serialVersionUID = -4617249924824485345L;
    ...
    /** default constructor */
	public PojoLimitPerday() {
	}

	/** minimal constructor */
	public PojoLimitPerday(Long TId, Long caseid, Long nums) {
		this.TId = TId;
		this.caseid = caseid;
		this.nums = nums;
	}
	...
	/** full constructor */
	public PojoLimitPerday(Long TId, Long caseid, Long nums, String risklevel,
