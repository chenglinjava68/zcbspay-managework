...
@Entity
@Table(name = "T_RISK")
public class PojoRisk implements java.io.Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -918527875961799758L;
	...
	/** minimal constructor */
	public PojoRisk(Long riskid, String riskver, String riskname, String prdtver,
