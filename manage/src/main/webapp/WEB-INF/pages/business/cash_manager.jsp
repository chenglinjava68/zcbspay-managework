...
<script>
	  ...
	  function showAdd(num) {
	  	...
	  	$('#saveForm :input').val('');
	  	$("#saveForm").attr("action", "product/addCash");
	  ...
	  function showUpdate(pid) {
	  	...
	  	$.ajax({
	  		type: "POST",
	  		url: "product/queryOneCash",
	  		data: "pid=" + pid,
	  		async: false,
	  		dataType: "json",
	  		success: function(json) {
	  			$("#saveForm").attr("action", "product/updateCash");
	  ...
	  function loadYwMark(pid) {
	  	...
	  	$.ajax({
	  		type: "GET",
	  		url: "product/queryChnlMark?pid=" + pid,
	  		data: "rand=" + new Date().getTime(),
	  		dataType: "json",
	  		success: function(json) {
	  			$.each(json,
