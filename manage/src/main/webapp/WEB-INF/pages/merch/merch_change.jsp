	...
	<div style="margin: 5px;" id="continer">
		<div id="title" name="title" class="easyui-panel" title="商户修改 "
			...
			<div style="padding-left: 5px; padding-right: 5px">
				<form id="merchDetaForm" action="merchant/saveChangeMerchDeta" method="post">
					...
					<table width="100%">
						...
						<tr>
							...
							<td colspan="3"><select id="province_ins"
								...
								class="easyui-validatebox" required="true"
								name="city" onchange="showCounty('city_ins')" /></select>
								<select id="county_ins" class="easyui-validatebox"
								required="true" name="street" /></select> <font
								color="red">*</font></td>
						</tr>
						<tr>
					...
					<tr> 
						...
						<tr>
							...
							<td><input name="agreemtStart" maxlength="12"
						...
						$.each(json,
							...
							if (value.RET == "succ") {
								...
								$.messager.confirm('提示', '保存成功,等待上传证件照片',function(data){
									if(data){
										window.location.href= "<%=basePath%>" +'/merchant/toUpload?merchApplyId='+value.INFO;
									}								
								});
							} else {
