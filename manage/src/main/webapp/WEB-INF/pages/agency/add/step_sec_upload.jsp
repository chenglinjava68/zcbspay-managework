	...
	<div style="margin: 5px;" id="continer">
		<div id="title" name="title" class="easyui-panel" title="委托机构开通"
			...
			<div style="padding-left: 5px; padding-right: 5px">
				<form id="merchDateForm" action="agency/commitMerch" method="post" enctype="multipart/form-data">
  ...
  $(function(){
	  $("input[id*='_cert_img']").each(function(){
		  ...
		  $(this).uploadify({
				...
				'uploader': '<%=basePath%>agency/upload',
	...
	function toFirstStep(){
		...
		window.location.href= "<%=basePath%>" +'agency/toMerchChange?merchApplyId=' + $('#merchApplyId').val();
	}
	
	function commitMerch(){
			$.ajax({
				type: "POST",
				url: "agency/commitMerch",
