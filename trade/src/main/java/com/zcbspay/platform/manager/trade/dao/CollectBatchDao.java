...
public interface CollectBatchDao extends BaseDAO<String> {
	 ...
	 * @version v1.0
	 */
	Map<String, Object> getBepsCollectBatchByPage(String page, String rows, CollectBatchBean collectBatchBean);
	/**
	 ...
	 * @version v1.0
	 */
	Map<String, Object> queryDetail(String page, String rows, CollectBatchBean collectBatchBean);
