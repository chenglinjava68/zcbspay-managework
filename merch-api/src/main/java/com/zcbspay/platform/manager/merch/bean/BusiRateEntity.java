...
@Table(name = "T_BUSI_RATE",  uniqueConstraints = @UniqueConstraint(columnNames = {
		"FEEVER", "BUSICODE" }))
public class BusiRateEntity implements java.io.Serializable {
	...
	/** default constructor */
	public BusiRateEntity() {
	}

	/** minimal constructor */
	public BusiRateEntity(Long tid, String feever, String busicode, BigDecimal feeRate) {
		this.tid = tid;
		this.feever = feever;
